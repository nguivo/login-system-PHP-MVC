...
<div class="kp-form-wrapper">
    ...
    <div class="kp-login-hint">
        <div class="kp-login-hint-wrapper">
            <h2>Caution!</h2>
            <p>We would like to advise you that you can only use your Username once. Utilizing your Username as e.g. a candidate and an administrator is not possible.</p>
        </div>
    </div>
    ...
    <div id="kc-form">
        <div id="kc-form-wrapper">
            <?php $form = Form::begin('', 'post'); ?>
                ...
                <div class="form-group">
                    <?php echo $form->field($model, 'adm_pwd')->passwordField(); ?>
                </div>
                ...
                <div id="kc-form-buttons" class="form-group">
                    <input tabindex="4" class="btn btn-primary  btn-lg" name="login" id="kc-login" type="submit" value="Log In" data-original-title="" title="">
                </div>
            <?php $form::end(); ?>
        </div>
    </div>
    ...
    <div id="kc-info">
        <div id="kc-info-wrapper" class="">
            <div id="kc-registration">
                <span>New user? <a tabindex="6" href="">Contact IT Department</a></span>
            </div>
        </div>
    </div>
</div>
